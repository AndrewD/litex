...
_build_template = [
    "yosys {quiet} -l {build_name}.rpt {build_name}.ys",
...
def _build_script(source, build_template, build_name, architecture, package, speed_grade, timingstrict, ignoreloops, bootaddr, seed, spimode, compress, quiet):
    ...
    def build(self, platform, fragment,
        ...
        **kwargs):
        ...
        script = _build_script(False, self.build_template, build_name, architecture, package,
                               speed_grade, timingstrict, ignoreloops, bootaddr, seed, spimode, compress, quiet)
        # Run
        if run:
            _run_script(script)
...
def trellis_args(parser):
    ...
    parser.add_argument("--yosys-quiet", action="store_true",
                        help="pass '-Qq' to yosys to be quiet")
